...
const DataPribadiForm = () => {
  ...
  const documents = [
    ...
    { key: "ktpPasangan", label: "Fotokopi KTP Suami / Istri" },
    { key: "kk", label: "Fotokopi Kartu Keluarga" },
    { key: "akte", label: "Fotokopi Akte Nikah/Cerai" },
    { key: "npwp", label: "Fotokopi NPWP Pemohon" },
    {
      key: "aktaPisah",
      label: "Akta Pisah Harga Notaril dan didaftarkan ke KUA atau catatan sipil (Jika Ada)",
    },
  ];
