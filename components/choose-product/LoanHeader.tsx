    ...
    <div>
      <div className="-mt-4 -ml-4 -mr-4 sm:-mt-6 sm:-ml-6 sm:-mr-6 bg-white border-b border-gray-200 shadow-sm">
        <div className="relative px-4 py-6 sm:px-6 sm:py-8">
          {/* Container utama untuk progress bar */}
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between w-full mt-6 mb-6 space-y-2 sm:space-y-0">
        ...
        <div className="text-center flex flex-col items-center px-2">
          <h1 className="text-lg sm:text-xl font-bold text-gray-800">Pilihan Produk & Bank</h1>
          <p className="text-xs sm:text-sm text-gray-600">Silahkan pilih produk bank yang sesuai di bawah</p>
        </div>

        <button className="flex items-center justify-center w-9 h-9 bg-[#17A9E2] text-white rounded-full hover:bg-[#1495c9] transition-colors">
